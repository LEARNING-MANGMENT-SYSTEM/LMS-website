  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="px-6 py-8">
        ...
        <p className="text-lg text-gray-600 mb-6 max-w-4xl">{subtitle}</p>
      ...
      >
        <img
          src={heroImage}
          alt="course img"
          className=" w-full h-64 md:h-80  lg:h-96 object-cover transition-transform 
            duration-300 " //md:w-90/100 md:ml-20 "
          loading="lazy"
        />
