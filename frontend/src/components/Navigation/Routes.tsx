...
import BecomeAnInstructor from "../../pages/BecomeAnInstructor/BecomeAnInstructor.tsx";
import Instructor from "../../pages/Instructor/index.tsx";
...
const routes = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/becomeInstructor", element: <BecomeAnInstructor /> },
